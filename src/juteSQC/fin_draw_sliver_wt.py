...
async def get_fin_draw_sliver_wt_setup(
    request: Request,
...
async def create_fin_draw_sliver_wt(
...
async def get_fin_draw_sliver_wt_by_date(
    request: Request,
    db: Session = Depends(get_tenant_db),
    token_data: dict = Depends(get_current_user_with_refresh),
):
...
async def get_fin_draw_sliver_wt_table(
    request: Request,
    db: Session = Depends(get_tenant_db),
    token_data: dict = Depends(get_current_user_with_refresh),
):
...
async def get_fin_draw_sliver_wt_by_id(
    request: Request,
    db: Session = Depends(get_tenant_db),
    token_data: dict = Depends(get_current_user_with_refresh),
):
...
async def fin_draw_sliver_wt_delete(
